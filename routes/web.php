...
Route::get('/cheque-number', \App\Livewire\ChequeImageStats::class)->name('cheque-number');
...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::middleware('role:staff')->prefix('staff')->name('staff.')->group(function () {
        ...
        Route::get('/day-summary', Income::class)->name('day-summary');
        Route::get('/loan-management', LoanManage::class)->name('loan-management');
    ...
    // Receipt download/print (accessible to authenticated users)
    Route::get('/receipts/{id}/download', [ReceiptController::class, 'download'])->name('receipts.download');
    Route::get('/receipts/{id}/print', [PrintController::class, 'printSale'])->name('receipts.print');
