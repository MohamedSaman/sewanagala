...
class StaffDashboard extends Component
{
    ...
    public function mount()
    {
        ...
        // Load category-wise sales data
        $this->loadCategorySales($userId);
    ...
    protected function loadCategorySales($userId)
    {
        try {
            ...
            if (empty($this->categorySales)) {
                $this->categorySales = $this->getFallbackCategorySales($userId);
            }
    ...
    private function getFallbackCategorySales($userId)
    {
