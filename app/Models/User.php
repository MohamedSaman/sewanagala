...
class User extends Authenticatable
{
    ...
    public function hasPermission($permissionKey)
    {
        ...
        // Default allowed keys for staff even with no explicit permissions assigned
        $defaultAllowedKeys = ['menu_dashboard'];

        if (in_array($permissionKey, $defaultAllowedKeys)) {
            return true;
        }
