            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div>
                    <div style="text-align: center; padding: 8px 0;">
                        <img src="{{ asset('images/logo.png') }}" alt="{{ config('shop.name') }}" class="img-fluid"
                            style="height: 60px; margin: 0 auto 8px;">
            ...
            <div class="col-md-6">
                ...
                @if($sale->payments->count() > 0)
                    @foreach($sale->payments as $payment)
                        <div
                            class="mb-2 p-2 border-start {{ $payment->is_completed ? 'border-success' : 'border-warning' }} bg-light">
                            <p class="mb-1">
        ...
        <div class="global-footer" style="margin-top: 40px;">
            <div style="display: flex; justify-content: center; text-align: center; margin-bottom: 20px;">
                <div style="flex: 0 0 33.3333%; max-width: 33.3333%; padding: 0 10px;">
                    ...
                    <img src="{{ public_path('images/logo.png') }}" alt="{{ config('shop.name') }}"
            ...
            <div style="border-top: 1px solid #3b5b0c; padding-top: 10px;">
                ...
                <p style="text-align: center;"><strong>TEL :</strong> {{ config('shop.phone') }}, <strong>EMAIL
                        :</strong> {{ config('shop.email') }}</p>
                <p style="text-align: center; font-size: 11px; margin-top: 8px;"><strong>Goods return will be accepted
                        within 14 days only.</strong></p>
            </div>
        </div>
    </div>
</body>
