<div class="container-fluid py-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="fw-bold mb-0">{{ $ProductStocks->sum('sold_qty') }}</h4>
    ...
    <div class="card h-100">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="search-bar flex-grow-1 ms-2 me-2">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="table-row" data-id="{{ $ProductStock->id }}">
                            ...
                            <td class="text-center">
                                <span class="fw-bold text-dark">{{ $ProductStock->calculated_total ?? '0' }}</span>
                            </td>
                            <td class="text-center">
