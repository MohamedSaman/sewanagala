                                ...
                                <td class="text-end pe-4">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            @if(auth()->user()->hasPermission('menu_sales_download'))
                                            <!-- Download Invoice -->
                                            <li>
                                            ...
                                            @endif
                                            @if(auth()->user()->hasPermission('menu_sales_print'))
                                            <li>
                                            ...
                                            @if(auth()->user()->hasPermission('menu_sales_delete'))
                                            <!-- Delete Sale -->
                                            <li>
                        ...
                        <div class="invoice-footer mt-4">
                            ...
                            <div class="border-top pt-3">
                                <p class="text-center mb-0"><strong>ADDRESS :</strong>
                                    {{ config('shop.address', 'N 122/1H, Kandy Road, Thihariya, Sri Lanka.') }}</p>
                                <p class="text-center mb-0"><strong>TEL :</strong>
                                    {{ config('shop.phone', '+0332 290 295') }}, <strong>EMAIL :</strong> {{
                                    config('shop.email', 'thihariyatilecenter@gmail.com') }}</p>
