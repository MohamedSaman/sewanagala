            ...
            <div class="inventory-header w-100 mb-3">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center w-100 gap-3">
                    ...
                    <div class="d-flex gap-2 justify-content-md-end">
                        @if(auth()->user()->hasPermission('menu_products_export'))
                        <button class="btn btn-outline-success" wire:click="exportProducts">
                            <i class="bi bi-download"></i>
                            <span class="d-none d-sm-inline">Export Excel</span>
                        </button>
                        @endif
                        @if(auth()->user()->hasPermission('menu_products_import'))
                        ...
                        @endif
                        @if(auth()->user()->hasPermission('menu_products_add'))
                                            ...
                                            <td class="text-end pe-4">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @if(auth()->user()->hasPermission('menu_products_delete'))
                                                        <li>
                                                            <button class="dropdown-item"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info border-0 mb-3">
                                    ...
                                    <strong>Note:</strong>
                                    <ul class="mb-0 mt-2">
                                        <li><strong>Damage Input:</strong> Use a positive value to add damage, or a negative value (example: -1) to reduce damage and move stock back to available</li>
                                        <li><strong>Add Damage:</strong> Increases damage stock and decreases available stock from batches (FIFO with fallback)</li>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="damageQuantity"
                                                ...
                                                placeholder="Enter +damage or -damage (ex: 5 or -1)">
                                        ...
                                        <button type="button" class="btn btn-danger w-100" wire:click="addDamageStock">
                                            <span wire:loading.remove wire:target="addDamageStock">
                                                <i class="bi bi-exclamation-triangle me-2"></i>Apply Damage Adjustment
                                            </span>
                                        ...
                                        <small class="text-muted d-block mt-2">
                                            Positive deducts available stock, negative restores available stock from damage
                                        </small>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="availableQuantity"
                                                wire:model="availableQuantity"
                                                placeholder="Enter quantity (e.g. 5 or -5)">
                                            @error('availableQuantity')
                                            <span class="text-danger small">* {{ $message }}</span>
                                            @enderror
                                        </div>
                                        <button type="button" class="btn btn-danger w-100" wire:click="adjustAvailableStock">
