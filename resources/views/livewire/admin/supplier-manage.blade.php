<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div>
            @if(auth()->user()->hasPermission('menu_people_suppliers_add'))
                                ...
                                <td class="text-end pe-2">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                            ...
                                            @if(auth()->user()->hasPermission('menu_people_suppliers_edit'))
                                            <!-- Edit Supplier -->
                                            <li>
                                                <button class="dropdown-item"
                                            ...
                                            @if(auth()->user()->hasPermission('menu_people_suppliers_delete'))
                                            <!-- Delete Supplier -->
                                            <li>
                                                <button class="dropdown-item"
