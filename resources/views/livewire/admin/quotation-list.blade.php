                                    ...
                                    <td class="text-end pe-4">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if($quotation->status !== 'converted' && auth()->user()->hasPermission('menu_sales_add'))
                                                <li>
                                                ...
                                                @if(auth()->user()->hasPermission('menu_quotation_delete'))
                                                <!-- Delete Quotation -->
                                                <li>
                                                    <button class="dropdown-item"
                ...
                <div class="modal-body">
                        ...
                        <div class="col-6 text-end">
                            <table class="table table-sm table-borderless">
                                <tr>
                                    ...
                                    <td>{{ $selectedQuotation->quotation_number }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ucfirst($selectedQuotation->status) }}</td>
                                </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <table class="table table-sm table-borderless">
                                <tr>
                                    <td class="text-end"><strong>Subtotal (LKR)</strong></td>
                                    <td class="text-end">{{ number_format($selectedQuotation->subtotal, 2) }}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ number_format($selectedQuotation->total_amount, 2) }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
