<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        ...
        <div>
            @if(auth()->user()->hasPermission('menu_people_customers_add'))
                            ...
                            <td class="text-end pe-2" wire:click.stop>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                        ...
                                        @if(auth()->user()->hasPermission('menu_people_customers_edit'))
                                        <!-- Edit Customer -->
                                        <li>
                                            <button class="dropdown-item"
                                        ...
                                        @if(auth()->user()->hasPermission('menu_people_customers_delete'))
                                        <!-- Delete Customer -->
                                        <li>
                                            <button class="dropdown-item"
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="saveCustomer">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-1">
                                    ...
                                    <small class="text-muted">you can add multiple contact numbers separated by slashes. (e.g. 03001234567 / 03001234568)</small>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Opening Balance Due</label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rs.</span>
                                        <input type="number" min="0" step="0.01" class="form-control @error('openingBalance') is-invalid @enderror"
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">Rs.</span>
                                        <input type="number" min="0" step="0.01" class="form-control @error('editOpeningBalance') is-invalid @enderror"
