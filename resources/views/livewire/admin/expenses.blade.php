    ...
    <div class="d-flex justify-content-between align-items-center mb-5 flex-wrap gap-3">
        ...
        <div class="d-flex align-items-end gap-2 flex-wrap">
            <div>
                ...
                <input type="date" class="form-control border-secondary" wire:model.live="fromDateFilter">
            </div>
            <div>
                <label class="form-label small text-muted mb-0">To Date</label>
                <input type="date" class="form-control border-secondary" wire:model.live="toDateFilter">
            </div>
            <div>
                <button class="btn btn-outline-secondary" type="button" wire:click="clearDateFilters" title="Clear Filter">
                    <i class="bi bi-arrow-clockwise"></i> Reset
                </button>
            </div>
            <div>
                <label class="form-label small text-muted mb-0">Show</label>
                <select class="form-select border-secondary" wire:model.live="perPage" style="width: 100px;">
            ...
            <div>
                <button wire:click="exportCSV" class="btn btn-success d-flex align-items-center gap-1 shadow-sm">
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if(auth()->user()->hasPermission('menu_expenses_add'))
                ...
                <div class="card-body p-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        @if(auth()->user()->hasPermission('menu_expenses_delete'))
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-2" style="font-size: 18px;">
                            <span class="fw-bold text-dark">Total</span>
                            <span class="fw-bold text-primary">Rs.{{ number_format($dailyFilteredTotal, 2) }}</span>
                        </div>
                        @if($dailyExpenses->hasPages())
                        <div class="d-flex justify-content-center">
                            {{ $dailyExpenses->links('livewire.custom-pagination') }}
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-2" style="font-size: 18px;">
                            <span class="fw-bold text-dark">Total</span>
                            <span class="fw-bold text-primary">Rs.{{ number_format($monthlyFilteredTotal, 2) }}</span>
                        </div>
                        @if($monthlyExpenses->hasPages())
                        <div class="d-flex justify-content-center">
                            {{ $monthlyExpenses->links('livewire.custom-pagination') }}
                        </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @if(auth()->user()->hasPermission('menu_expenses_edit'))
