    ...
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            <div class="form-panel">
                ...
                @if (session('status'))
                    <div class="alert alert-success mb-4 rounded-3 border-0 shadow-sm" style="font-size: 0.85rem; padding: 12px; background-color: #d1e7dd; color: #0f5132;">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <!-- Options -->
                    <div class="form-options mb-4 mt-2" style="justify-content: space-between;">
                        <a href="{{ route('welcome') }}" class="forgot-link">
                    ...
                    <button type="submit" class="login-btn">
                        <i class="bi bi-envelope-check me-2"></i>Email Password Reset Link
                    </button>
