...
<body>
    {{-- Header --}}
    <div class="header">
        <img src="{{ public_path('images/logo.png') }}" alt="{{ config('shop.name') }} Logo">
        <p>{{ config('shop.address', 'N 122/1H, Kandy Road, Thihariya, Sri Lanka.') }}</p>
        <p><strong>TEL:</strong> {{ config('shop.phone', '+0332 290 295') }} | <strong>EMAIL:</strong> {{ config('shop.email', 'thihariyatilecenter@gmail.com') }}</p>
    ...
    <div class="footer">
        ...
        <p><strong>{{ config('shop.name') }}</strong> - Point of Sale System</p>
    </div>
</body>
